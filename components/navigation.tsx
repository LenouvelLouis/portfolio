...
export default function Navigation({ activeSection, setActiveSection }: NavigationProps) {
    ...
    return (
        <aside className="w-full h-screen md:w-64 border-r border-border bg-card p-6 md:p-8 flex flex-col justify-between">
            <div>
                ...
                <nav className="space-y-1">
                    {sections.map((section) => (
                        <button
                            ...
                            className={`block w-full text-left px-4 py-2 rounded-lg transition-colors text-sm md:text-base ${
                    ...
                    <a
                        href="/cv.pdf"
                        download
                        className="block w-full text-left px-4 py-2 rounded-lg transition-colors text-sm md:text-base text-foreground hover:bg-muted"
                    >
                        {labels[language].cv}
                    </a>
                </nav>
